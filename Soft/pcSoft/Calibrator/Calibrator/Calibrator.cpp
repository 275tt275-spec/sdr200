...
// Calibrator.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCalibratorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CCalibratorApp

CCalibratorApp::CCalibratorApp()
{
...
// Единственный объект CCalibratorApp

CCalibratorApp theApp;


// Инициализация CCalibratorApp

BOOL CCalibratorApp::InitInstance()
{
