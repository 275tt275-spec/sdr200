...
extern FIRCORE create_fircore (int size, float* in, float* out, 
...
extern void setBuffers_fircore (FIRCORE a, float* in, float* out);
extern void setSize_fircore (FIRCORE a, int size);
extern void setImpulse_fircore (FIRCORE a, float* impulse, int update);
extern void setNc_fircore (FIRCORE a, int nc, float* impulse);
