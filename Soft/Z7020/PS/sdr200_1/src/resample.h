...
extern void setBuffers_resample (RESAMPLE a, float* in, float* out);
...
extern void setFCLow_resample (RESAMPLE a, float fc_low);
extern void setBandwidth_resample (RESAMPLE a, float fc_low, float fc_high);
