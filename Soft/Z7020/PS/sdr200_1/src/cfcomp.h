...
extern CFCOMP create_cfcomp (int run, int position, int peq_run, int size, float* in, float* out, int fsize, int ovrlp, 
...
extern void setBuffers_cfcomp (CFCOMP a, float* in, float* out);
