...
extern void setBuffers_snotch (SNOTCH a, float* in, float* out);
...
extern void setBuffers_speak (SPEAK a, float* in, float* out);
...
extern void setBuffers_mpeak (MPEAK a, float* in, float* out);
...
extern PHROT create_phrot (int run, int size, float* in, float* out, int rate, float fc, int nstages);
extern void destroy_phrot (PHROT a);
extern void flush_phrot (PHROT a);
extern void xphrot (PHROT a);
extern void setBuffers_phrot (PHROT a, float* in, float* out);
...
extern BQLP create_bqlp(int run, int size, float* in, float* out, float rate, float fc, float Q, float gain, int nstages);
extern void destroy_bqlp(BQLP a);
extern void flush_bqlp(BQLP a);
extern void xbqlp(BQLP a);
extern void setBuffers_bqlp(BQLP a, float* in, float* out);
...
extern BQLP create_dbqlp(int run, int size, float* in, float* out, float rate, float fc, float Q, float gain, int nstages);
extern void destroy_dbqlp(BQLP a);
extern void flush_dbqlp(BQLP a);
extern void xdbqlp(BQLP a);
extern void setBuffers_dbqlp(BQLP a, float* in, float* out);
...
extern BQBP create_bqbp(int run, int size, float* in, float* out, float rate, float f_low, float f_high, float gain, int nstages);
extern void destroy_bqbp(BQBP a);
extern void flush_bqbp(BQBP a);
extern void xbqbp(BQBP a);
extern void setBuffers_bqbp(BQBP a, float* in, float* out);
...
extern BQBP create_dbqbp(int run, int size, float* in, float* out, float rate, float f_low, float f_high, float gain, int nstages);
extern void destroy_dbqbp(BQBP a);
extern void flush_dbqbp(BQBP a);
extern void xdbqbp(BQBP a);
extern void setBuffers_dbqbp(BQBP a, float* in, float* out);
...
extern SPHP create_dsphp(int run, int size, float* in, float* out, float rate, float fc, int nstages);
extern void destroy_dsphp(SPHP a);
extern void flush_dsphp(SPHP a);
extern void xdsphp(SPHP a);
extern void setBuffers_dsphp(SPHP a, float* in, float* out);
...
extern SPHP create_sphp(int run, int size, float* in, float* out, float rate, float fc, int nstages);
extern void destroy_sphp(SPHP a);
extern void flush_sphp(SPHP a);
extern void xsphp(SPHP a);
extern void setBuffers_sphp(SPHP a, float* in, float* out);
