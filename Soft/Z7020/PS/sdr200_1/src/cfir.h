...
extern CFIR create_cfir (int run, int size, int nc, int mp, float* in, float* out, int runrate, int cicrate, 
...
extern void setBuffers_cfir (CFIR a, float* in, float* out);
...
extern float* cfir_impulse (int N, int DD, int R, int Pairs, float runrate, float cicrate, 
	float cutoff, int xtype, float xbw, int rtype, float scale, int wintype);
