...
ARCHITECTURE behavior OF lim_tb IS 
 ...
 PORT(
        ...
        lim_over : out STD_LOGIC_VECTOR (1 downto 0);
        aclk : in STD_LOGIC
	  );
 END COMPONENT;
...
signal s_axis_audio_tdata : STD_LOGIC_VECTOR (23 downto 0);
signal s_axis_audio_tvalid : STD_LOGIC; 
signal s_axis_cfg_tdata : STD_LOGIC_VECTOR (31 downto 0);
signal s_axis_cfg_tdest : STD_LOGIC_VECTOR (2 downto 0);
signal s_axis_cfg_tvalid : STD_LOGIC;
signal lim_over : STD_LOGIC_VECTOR (1 downto 0);
...
read_from_file: process
    ...
    file data_in: inputFile_t open read_mode is "E:\Projects\StationVT\Soft\fpga\limiter\300.raw";
    file data_out: inputFile_t open write_mode is "E:\Projects\StationVT\Soft\fpga\limiter\audio_out.raw";
    begin        
  ...
  --     s_axis_audio_tdata <= x"000000";
        ...
        if endfile(data_in) then
            ...
            file_close(data_in);
            file_close(data_out);
            file_open(data_in,"E:\Projects\p75\Fpga\Speech\audio.raw");
        end if;
end process;
