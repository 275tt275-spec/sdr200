----------------------------------------------------------------------------------
--
-- Create Date:    15:21:11 07/22/2013 
--
-- c = a * b
-- Delay : 2 clocks
----------------------------------------------------------------------------------
...
architecture Behavioral of mult48cc is

signal p48 : std_logic_vector(47 downto 0);
signal a30 : std_logic_vector(29 downto 0);
...
dsp : DSP48E1
	...
	-- Data: 4-bit (each) output: Data Ports
		...
		P => p48, -- 48-bit output: Primary data output
	...
	-- Data: 30-bit (each) input: Data Ports
		A => a30, -- 30-bit input: A data input
...
a30 <= "00000" & a(17) & a(17) & a(17) & a(17) & a(17) & a(17) & a(17) & a;
m <= p48(35 downto 0);
